    ...
    <aside className="sidebar">
      ...
      <div className="sidebar-brand">
        <div className="sidebar-brand-logo">
          {/* Hexagon Logo in Screenshot */}
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M12 2L2 7V17L12 22L22 17V7L12 2Z" stroke="currentColor" strokeWidth="2" strokeLinejoin="round"/>
            <path d="M12 6L6 9V15L12 18L18 15V9L12 6Z" fill="currentColor"/>
          </svg>
        </div>
        <span className="sidebar-brand-name">Beyond UI</span>
        <button className="sidebar-brand-dropdown-btn">
      ...
      <div className="sidebar-support-card">
        ...
        <p className="support-subtitle">Get in touch with our agents</p>
        <Button variant="outline" className="support-button">Contact us</Button>
      </div>
      ...
      <div className="sidebar-footer">
        <div className="user-profile">
          ...
          <div className="user-info">
            <span className="user-name">Anna Taylor</span>
            <span className="user-email">anna.t@email.com</span>
          </div>
        </div>
